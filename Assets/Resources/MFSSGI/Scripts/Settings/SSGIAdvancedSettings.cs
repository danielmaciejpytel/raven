...
namespace MF.SSGI.Settings {
    ...
    public class SSGIAdvancedSettings : ScriptableObject {
        ...
        [Tooltip("Weight of previous-frame shadows. Lower values reduce trails but retain more sampling noise.")]
        [Range(0f, 0.95f)] public float ShadowHistoryWeight = 0.85f;
        [Tooltip("Maximum world-space position difference before shadow history is rejected.")]
        [Range(0.001f, 0.2f)] public float ShadowHistoryPositionThreshold = 0.1f;
