...
namespace Unity.AI.Assistant.UI.Editor.Scripts.Components
{
    ...
    {
        static string InfoLabelText =>
            $"The Asset Knowledge add-on uses a local image model to tag and classify project assets, improving Assistant’s responses with more context. <color={AssistantUIConstants.LinkColorForCurrentSkin}><link=\"packageInfo\">Read more</link></color>";
