...
namespace Unity.AI.Assistant.UI.Editor.Scripts.Components.WhatsNew
{
    class WhatsNewBanner : ManagedTemplate
    {
        ...
        {
            "<b>Domain reload resilience</b>: in-flight prompts, attachments, and tool calls now survive domain reloads instead of being lost.",
            "<b>Automatic recovery</b> from mid-turn connection loss — interrupted turns auto-continue instead of hanging or timing out.",
            "<b>Credit and access banners</b> now read your org's AI subscription directly from the backend and link to the dashboard credits page.",
            "Many bug fixes, including completed conversations falsely resuming as \"Preparing…\" after a domain reload, MCP port collisions between concurrent editor relays, and Light Mode contrast issues."
        };
